...
## Screenshots
<p align="center">
   <img src="assets/Screenshots/screenshot1.png" alt="Screenshot 1" width="320" style="margin:8px;" />
   <img src="assets/Screenshots/screenshot2.png" alt="Screenshot 2" width="320" style="margin:8px;" />
   <img src="assets/Screenshots/screenshot3.png" alt="Screenshot 3" width="320" style="margin:8px;" />
   <img src="assets/Screenshots/screenshot4.png" alt="Screenshot 4" width="320" style="margin:8px;" />
</p>
...
1. **Clone the repository**
   ```sh
   git clone https://github.com/Benjaminax/pdf-x-web-app.git
   cd pdf-x-web-app
   ```
